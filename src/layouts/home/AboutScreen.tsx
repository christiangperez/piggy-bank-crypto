      ...
      <Grid container justifyContent='space-between' sx={{ mt: 5 }}>
        ...
        <Grid item xs={12} md={4} spacing={2} sx={{ paddingLeft: 2, paddingRight: 2 }}>
          <Paper sx={{ padding: 2, backgroundColor: 'primary.light' }}>
            ...
            <Grid container alignItems='center' sx={{ mt: 1, color: 'white' }}>
              <img src='../../assets/typescript.png' alt="typescript" width={24} height={24} style={{ marginRight: 5 }} />
              Typescript
            </Grid>
            <Grid container alignItems='center' sx={{ mt: 1, color: 'white' }}>
            ...
            <Grid container alignItems='center' sx={{ mt: 1, color: 'white' }}>
              <img src='../../assets/react-testing-library.png' alt="react-testing-library" width={24} height={24} style={{ marginRight: 5 }} />
