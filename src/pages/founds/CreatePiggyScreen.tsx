...
export const CreatePiggyScreen = () => {
	...
	const { account, hasDeposit } = useSelector((state: IRootState) => state.wallet);
				...
				{!hasDeposit ? (
					<>
						...
						<Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
							...
							{account ? (
								<Button fullWidth variant="contained" sx={{ mt: 3, mb: 2 }} onClick={handleClickCreate}>
									CREATE
								</Button>
							) : (
					...
					<>
						...
						<Button fullWidth variant="contained" sx={{ mt: 3, mb: 2 }} onClick={handleClickViewMyDeposit}>
							VIEW MY DEPOSIT
						</Button>
					</>
				)}
