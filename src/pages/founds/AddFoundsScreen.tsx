...
export const AddFoundsScreen = () => {
	...
	const { account, activeDeposit, depositAdded } = useSelector((state: IRootState) => state.wallet);
		...
		<Container component="main" maxWidth="xs">
			...
			>
				...
				{activeDeposit ? (
						...
						<Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
							{showDepositAdded ? (
								<Grid container spacing={2}>
									<Grid item xs={12}>
										<Typography variant="h6">Your ETH deposit has been added into your Crypto Piggy Bank</Typography>
									</Grid>
								</Grid>
							) : (
								<Grid container spacing={2}>
									<Grid item xs={12}>
										<Typography variant="h6">You have {activeDeposit?.amount} ETH in your Piggy Bank</Typography>
									</Grid>
									<Grid item xs={12}>
										<TextField
											required
									...
									{account ? (
										<Button fullWidth variant="contained" sx={{ mt: 3, mb: 2 }} onClick={handleClickAdd}>
											ADD
										</Button>
									) : (
					...
					<Typography variant="h4">You don't have a Crypto Piggy Bank CREATED</Typography>
				)}
			</Box>
		</Container>
	);
