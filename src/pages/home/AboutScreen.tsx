			...
			<Grid container justifyContent='space-between' sx={{ mt: 5 }}>
				<Grid item xs={12} md={6} sx={{ paddingLeft: 2, paddingRight: 2 }}>
					...
					<Typography variant='subtitle1' sx={{ mt: 2 }}>
						In Crypto Piggy Bank you can save your ETH directly in Ethereum's
						Blockchain. Your founds will be in a Smart Contract, these contracts
						are immutables and there is no posibility to modify anyone. Your
						deposit will be secure thanks to the Ethereum's Blockchain
